...
const ChatAssistant = () => {
  ...
  const [messages, setMessages] = useState([
    {
      sender: "bot",
      text: "Halo! Saya asisten AI MangroveSight. Ada yang bisa saya bantu terkait data Mangrove di Teluk Balikpapan?",
    },
  ]);
